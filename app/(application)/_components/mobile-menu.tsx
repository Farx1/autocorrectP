...
import {
    favoriteLinks,
    navigationLinks,
} from "@/app/(application)/_components/sidebar";
                ...
                >
                    ...
                    >
                        ...
                        <DialogPrimitives.Description className="sr-only">
                            This menu provides mobile navigation options,
                            including access to main navigation links, favorite
                            projects, search, and user settings.

...
export const navigationLinks: NavigationLink[] = [
    ...
    { icon: RiCalendarLine, label: "Calendar", href: "#", disabled: true },
    { icon: RiFoldersLine, label: "Projects", href: "#", disabled: true },
    { icon: RiGroupLine, label: "Teams", href: "#", disabled: true },
    { icon: RiEqualizerLine, label: "Integrations", href: "#", disabled: true },
                ...
                {favoriteLinks.map((project, i) => (
                    ...
                    >
                        ...
                        >
                            ...
                            {project.shortcut && (
                                <Kbd.Root>{project.shortcut}</Kbd.Root>
                            )}
                        </div>
                    </Link>
                ))}
...
function SettingsAndSupport({ collapsed }: { collapsed: boolean }) {
    ...
    return (
        <div className="mt-auto space-y-1.5">
            {links.map(({ href, icon: Icon, label, disabled, current }, i) => {
                return (
                    <Link
                        key={i}
                        href={href}

            ...
            <div className="flex flex-col gap-3">
                <div className="flex items-start gap-2">
                    ...
                    >
                        ...
                        <div className="text-paragraph-xs text-text-sub-600">
                            Updates on approved leaves, attendance records, and
                            important attendance-related reminders.
                        </div>
                    </Label.Root>
                </div>
                ...
                <div className="flex items-start gap-2">
                    ...
                    >
                        ...
                        <div className="text-paragraph-xs text-text-sub-600">
                            Receive timely reminders before approaching
                            deadlines.
                        </div>
                    </Label.Root>
                </div>
